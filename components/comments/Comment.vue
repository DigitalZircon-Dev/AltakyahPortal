<template>
  <v-card v-if="!comment.isDeleted" class="mx-auto" :class="repliedClass">
    <v-list-item>
      ...
      <v-list-item-content>
        ...
        <v-list-item-subtitle>{{ comment.createdOn }}</v-list-item-subtitle>
      </v-list-item-content>
    </v-list-item>
    <v-card-text>
    ...
    <!-- display childrens -->
    <div v-for="commentReply in comment.commentReplies" :key="commentReply.id">
      <comment
        :key="commentReply.id"
